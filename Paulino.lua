-- ==========================================
-- PAULINO HUB MM2 - COMPLETO E FUNCIONAL
-- ==========================================
...
if CoreGui:FindFirstChild("PaulinoGUI") then
    CoreGui.PaulinoGUI:Destroy()
end
...
FlingBtn.Position = UDim2.new(0.5, -110, 0.5, -20)
